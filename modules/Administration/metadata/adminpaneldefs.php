...
$admin_option_defs['Administration']['import']= array('Import','LBL_IMPORT_WIZARD','LBL_IMPORT_WIZARD_DESC','javascript:void(0)','','return SUGAR.importWizard.renderDialog("Administration","step1","");');

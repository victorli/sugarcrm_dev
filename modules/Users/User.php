   ...
   {	
   	...
   	if(!is_sys_admin($GLOBALS['current_user'])){
   		if(is_tenant($GLOBALS['current_user'])){
   			if(empty($where))
   				$where =" ($this->table_name.id='".$GLOBALS['current_user']->id."' OR $this->table_name.tenant_id='".$GLOBALS['current_user']->id."') ";
   			else
   				$where .=" AND ($this->table_name.id='".$GLOBALS['current_user']->id."' OR $this->table_name.tenant_id='".$GLOBALS['current_user']->id."') ";	
   		}else{
   			if(empty($where))
   				$where =" ($this->table_name.id='".$GLOBALS['current_user']->tenant_id."' OR $this->table_name.tenant_id='".$GLOBALS['current_user']->tenant_id."') ";
   			else

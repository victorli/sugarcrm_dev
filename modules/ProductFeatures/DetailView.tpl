...
<form action="index.php" method="post" name="DetailView" id="form">
			...
			<input type="hidden" name="module" value="ProductFeatures">
			<input type="hidden" name="user_id" value="">
			<input type="hidden" name="record" value="{$PF.id}">
...
EOD
    ...
    $this->append('buttons',
    <<<EOD
    <input title="{$APP['LBL_DELETE_BUTTON_TITLE']}" accessKey="{$APP['LBL_DELETE_BUTTON_KEY']}" class="button" onclick="this.form.return_module.value='ProductFeatures'; this.form.return_action.value='index'; this.form.action.value='Delete'; return confirm('{$APP['NTC_DELETE_CONFIRMATION']}')" type="submit" name="button" value=" {$APP['LBL_DELETE_BUTTON']} " />
EOD
    );
{/php}
...
{include file="modules/ProductFeatures/EditViewBody.tpl" }

...
if(ACLController::checkAccess('Leads', 'import', true))$module_menu[]=Array("javascript:void(SUGAR.importWizard.renderDialog('Leads','step1',''));", $mod_strings['LNK_IMPORT_LEADS'],"Import", 'Leads');
?>
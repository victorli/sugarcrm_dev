...
{if $showimport}if(ACLController::checkAccess('{$moduleName}', 'import', true))$module_menu[]=Array("javascript:void(SUGAR.importWizard.renderDialog('{$moduleName}','step1',''));", $app_strings['LBL_IMPORT'],"Import", '{$moduleName}');{/if}
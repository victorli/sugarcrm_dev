...
class SugarTinyMCE {
	...
	var $buttonConfigs = array(
			'default' => array(
	                    ...
	                    'buttonConfig2' => "cut,copy,paste,pastetext,pasteword,selectall,separator,search,replace,separator,bullist,numlist,separator,outdent,
	                     					indent,separator,ltr,rtl,separator,undo,redo,separator, link,unlink,anchor,image,jbimage,separator,sub,sup,separator,charmap,
	                     					visualaid",
	...
	var $defaultConfig = array(
		...
		'mode'	=> 'exact',
		'language' => 'en',
	    'plugins' => 'jbimage,advhr,insertdatetime,table,preview,paste,searchreplace,directionality',
		'elements'	=> '',

...
onchange='document.{{$form_name}}.{{sugarvar key='name'}}.value="";document.{{$form_name}}.parent_id.value=""; 
	{{$vardef.type_name}}changeQS(); checkParentType(document.{{$form_name}}.{{$vardef.type_name}}.value, document.{{$form_name}}.btn_{{sugarvar key='name'}});'>
...
function {{$vardef.type_name}}changeQS() {ldelim}
	new_module = document.forms["{{$form_name}}"].elements["{{$vardef.type_name}}"].value;
